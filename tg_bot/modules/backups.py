...
def export_data(update, context):  # sourcery no-metrics
    ...
    with open("https://t.me/The3000GangRobot{}.json".format(chat_id), "w") as f:
        f.write(str(baccinfo))
    context.bot.sendChatAction(current_chat_id, "upload_document")
    tgl = time.strftime("%H:%M:%S - %d/%m/%Y", time.localtime(time.time()))
    context.bot.sendDocument(
        current_chat_id,
        document=open("https://t.me/The3000GangRobot{}.json".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `https://t.me/The3000GangRobot-Backup` was specially made for notes.".format(
    ...
    os.remove("https://t.me/The3000GangRobot{}.json".format(chat_id))  # Cleaning file
