...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        ...
        {
            "title": "Account info on https://t.me/The3000Gang",
            "description": "Look up a Telegram account in https://t.me/The3000Gang database",
            "message_text": "Click the button below to look up a person in https://t.me/The3000Gang database using their Telegram ID",
            "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
            "keyboard": ".info ",
        },
        {
            "title": "About",
            "description": "Know about https://t.me/The3000Gang",
            "message_text": "Click the button below to get to know about https://t.me/The3000Gang.",
            "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
            "keyboard": ".about ",
        },
        {
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    sql.update_user(user.id, user.username)
    about_text = f"""
    https://t.me/The3000Gang (@{context.bot.username})
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(
                    text="Channel",
                    url=f"https://t.me/https://t.me/The3000GangUpdates",
                ),
                InlineKeyboardButton(
                    text='Ping',
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About https://t.me/The3000Gang (@{context.bot.username})",
